...
namespace Engine
{
  namespace Render
  {
    Pipeline::Pipeline(RenderDevice& device, const string& vertFilepath, const string& fragFilepath, const PipelineConfigInfo& configInfo) :
      renderDevice(device)
    {
    ...
    void Pipeline::createGraphicsPipeline(const string& vertFilepath, const string& fragFilepath, const PipelineConfigInfo& configInfo)
    {
      ...
      shaderStages[0].pName = "main"; // name of function in a vertex shader
      ...
      shaderStages[1].pName = "main"; // name of function in a vertex shader
      shaderStages[1].flags = 0;
      shaderStages[1].pNext = nullptr;
      shaderStages[1].pSpecializationInfo = nullptr;

      auto bindingDescription = Engine::Render::ModelData::Vertex::getBindingDescription();
      auto attributeDescription = Engine::Render::ModelData::Vertex::getAttributeDescription();
      ...
      pipelineInfo.stageCount = 2; // how many programmable stages vulkan will use
      ...
      assert(pipelineInfo.pViewportState->sType == VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO);
      //assert(pipelineInfo.pViewportState->viewportCount == 1);
    ...
    void Pipeline::bind(VkCommandBuffer commandBuffer)
    {
      ...
      // other options: compute pipeline and raytracing pipeline
      vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
    }

    void Pipeline::initDefaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
    {
    ...
    void Pipeline::createShaderModule(vector<char>& shaderCode, VkShaderModule* shaderModule)
    {
